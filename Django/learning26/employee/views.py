...
def employeeFilter(request):
    ...
    #contains
    employee8 = Employee.objects.filter(name__contains="p").values()
    employee9 = Employee.objects.filter(name__icontains="P").values()

    #startswith endswith
    employee10 = Employee.objects.filter(name__startswith="i").values()
    employee11 = Employee.objects.filter(name__endswith="i").values()
    employee12 = Employee.objects.filter(name__istartswith="i").values()
    employee13 = Employee.objects.filter(name__iendswith="i").values()
